  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 rounded-3xl border border-slate-800 bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden group shadow-2xl hover:border-slate-700 transition-all duration-300">
          ...
          <div className="my-6 p-5 rounded-2xl bg-slate-950 border border-slate-800 relative overflow-hidden">
            {/* The Laser Sweep Bar */}
            {scanning && (
            ...
            <div className="space-y-3 relative z-10">
              <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                <span className="text-xs text-slate-400 uppercase font-mono font-bold">Document Source</span>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  ...
                  <div className="font-bold text-white text-sm truncate">{scannedData.merchant}</div>
                </div>
                <div className="text-right">
                  <span className="text-[10px] text-slate-500 uppercase font-bold">Total Amount</span>
                  <div className="font-bold text-emerald-400 text-sm">${scannedData.amount}</div>
                </div>
                <div>
                  <span className="text-[10px] text-slate-500 uppercase font-bold">Category</span>
                  <div className="text-slate-300 font-medium">{scannedData.category}</div>
                </div>
                <div className="text-right">
                  <span className="text-[10px] text-slate-500 uppercase font-bold">AI Confidence</span>
                  <div className="text-blue-400 font-bold font-mono">{scannedData.confidence}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <Button
            ...
            disabled={scanning}
            className="w-full h-11 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-xs shadow-lg shadow-blue-500/20 active:scale-98 relative z-10"
          >
        ...
        <div className="lg:col-span-5 rounded-3xl border border-slate-800 bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden group shadow-2xl hover:border-slate-700 transition-all duration-300">
          <div className="space-y-3 relative z-10">
            <div className="flex items-center justify-between">
          ...
          <div className="space-y-3.5 my-6 relative z-10">
            <div>
              <div className="flex justify-between text-xs font-semibold mb-1">
                <span className="text-slate-300">Equities & Index Funds (52%)</span>
                <span className="text-white font-mono">$66,794</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs font-semibold mb-1">
                <span className="text-slate-300">High-Yield Treasury Cash (28%)</span>
                <span className="text-white font-mono">$35,966</span>
              </div>
              <div className="h-2 w-full bg-slate-950 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs font-semibold mb-1">
                <span className="text-slate-300">Crypto & Digital Assets (20%)</span>
                <span className="text-white font-mono">$25,690</span>
              </div>
              <div className="h-2 w-full bg-slate-950 rounded-full overflow-hidden">
          ...
          <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 flex items-center justify-between text-xs text-slate-300 relative z-10">
            <span className="font-semibold text-emerald-400">Total Portfolio Value</span>
            <span className="font-mono font-black text-white text-sm">$128,450.00</span>
          </div>
        </div>

        {/* Tile 3: Autonomous Budget Alert Sentinel (Span 6) */}
        <div className="lg:col-span-6 rounded-3xl border border-slate-800 bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden group shadow-2xl hover:border-slate-700 transition-all duration-300">
          <div className="space-y-3 relative z-10">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-3 my-4 relative z-10">
            <div className="flex justify-between text-xs font-semibold">
              <span className="text-slate-300">Monthly Operating Budget</span>
              <span className="text-amber-400 font-mono font-bold">$3,420 / $4,000 (85.5%)</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-[11px] text-amber-300 bg-amber-500/10 border border-amber-500/20 p-2 rounded-lg">
        ...
        <div className="lg:col-span-6 rounded-3xl border border-slate-800 bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden group shadow-2xl hover:border-slate-700 transition-all duration-300">
          ...
          <div className="grid grid-cols-2 gap-3 my-4 relative z-10 text-xs font-mono">
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
              ...
              <div className="text-emerald-400 font-bold">Arcjet Security Active</div>
            </div>
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
              <div className="text-[10px] text-slate-500 uppercase">Latency</div>
              <div className="text-blue-400 font-bold">&lt; 14ms Global Edge</div>
            </div>
          </div>
        </div>
